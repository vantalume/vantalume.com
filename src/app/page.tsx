...
export default function Home() {
  return <>
    ...
    <section className="section shell"><div className="section-head"><p className="kicker">Start with a decision</p><h2>Not sure whether you need a website, an app or automation?</h2><p>Use the Opportunity Scorecard. Five short questions produce an immediate signal; email is only needed if you choose to receive the complete take-away report.</p></div><div className="mapper-preview"><div className="radar" aria-hidden="true"><span/><span/><span/><b>?</b></div><div><p className="label">Free interactive tool · about 3 minutes</p><h3>Turn a fuzzy business problem into a clearer digital next step.</h3><ButtonLink href="/opportunity-mapper">Open the scorecard</ButtonLink></div></div></section>
